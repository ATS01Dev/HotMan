...
import bj.ats.hm.domain.Department;
import bj.ats.hm.repository.DepartmentRepository;
import bj.ats.hm.service.DepartmentService;
import bj.ats.hm.repository.search.DepartmentSearchRepository;
...
public class DepartmentResourceIntTest {
    ...
    private static final String DEFAULT_NAMEDEPARTEMENT = "AAAAAAAAAA";
    private static final String UPDATED_NAMEDEPARTEMENT = "BBBBBBBBBB";
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department()
            .namedepartement(DEFAULT_NAMEDEPARTEMENT)
    ...
    public void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getNamedepartement()).isEqualTo(DEFAULT_NAMEDEPARTEMENT);
    ...
    public void getAllDepartments() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].namedepartement").value(hasItem(DEFAULT_NAMEDEPARTEMENT.toString())))
    ...
    public void getDepartment() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments/{id}", department.getId()))
            ...
            .andExpect(jsonPath("$.namedepartement").value(DEFAULT_NAMEDEPARTEMENT.toString()))
    ...
    public void updateDepartment() throws Exception {
        ...
        updatedDepartment
            .namedepartement(UPDATED_NAMEDEPARTEMENT)
        ...
        Department testDepartment = departmentList.get(departmentList.size() - 1);
        assertThat(testDepartment.getNamedepartement()).isEqualTo(UPDATED_NAMEDEPARTEMENT);
