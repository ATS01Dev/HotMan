...
public class ClientResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_DATECOME = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DATECOME = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.getDatecome()).isEqualTo(DEFAULT_DATECOME);
        assertThat(testClient.getDatego()).isEqualTo(DEFAULT_DATEGO);
        assertThat(testClient.getDuration()).isEqualTo(DEFAULT_DURATION);
        assertThat(testClient.isReservation()).isEqualTo(DEFAULT_RESERVATION);
    ...
    public void updateClient() throws Exception {
        ...
        assertThat(testClient.getDatecome()).isEqualTo(UPDATED_DATECOME);
        assertThat(testClient.getDatego()).isEqualTo(UPDATED_DATEGO);
        assertThat(testClient.getDuration()).isEqualTo(UPDATED_DURATION);
        assertThat(testClient.isReservation()).isEqualTo(UPDATED_RESERVATION);
