...
public class GroupeResourceIntTest {
    ...
    private static final String DEFAULT_NBPERSON = "AAAAAAAAAA";
    private static final String UPDATED_NBPERSON = "BBBBBBBBBB";
    ...
    public void createGroupe() throws Exception {
        ...
        assertThat(testGroupe.getNbperson()).isEqualTo(DEFAULT_NBPERSON);
    ...
    public void getAllGroupes() throws Exception {
        ...
        restGroupeMockMvc.perform(get("/api/groupes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nbperson").value(hasItem(DEFAULT_NBPERSON.toString())));
    }
    ...
    public void getGroupe() throws Exception {
        ...
        restGroupeMockMvc.perform(get("/api/groupes/{id}", groupe.getId()))
            ...
            .andExpect(jsonPath("$.nbperson").value(DEFAULT_NBPERSON.toString()));
    }
    ...
    public void updateGroupe() throws Exception {
        ...
        assertThat(testGroupe.getNbperson()).isEqualTo(UPDATED_NBPERSON);
