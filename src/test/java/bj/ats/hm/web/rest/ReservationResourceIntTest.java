...
public class ReservationResourceIntTest {
    ...
    public void createReservation() throws Exception {
        ...
        assertThat(testReservation.getDebut()).isEqualTo(DEFAULT_DEBUT);
        assertThat(testReservation.getFin()).isEqualTo(DEFAULT_FIN);
    ...
    public void updateReservation() throws Exception {
        ...
        assertThat(testReservation.getDebut()).isEqualTo(UPDATED_DEBUT);
        assertThat(testReservation.getFin()).isEqualTo(UPDATED_FIN);
