...
public class ReservationResource {
    ...
    @Timed
    public ResponseEntity<List<Reservation>> getAllReservations(@ApiParam Pageable pageable, @RequestParam(required = false) String filter) {
        if ("rooms-is-null".equals(filter)) {
            log.debug("REST request to get all Reservations where rooms is null");
            return new ResponseEntity<>(reservationService.findAllWhereRoomsIsNull(),
                    HttpStatus.OK);
        }
